          ...
          >
            ...
            >
              <Textarea
                ...
                className="flex-1 min-h-100 max-w-full resize-none p-6 text-base leading-relaxed border-muted-foreground/20 focus-visible:ring-primary/30 transition-all duration-300 bg-background/50 overflow-auto break-words whitespace-pre-wrap"
                value={content}
